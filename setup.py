...
setup(
  ...
  url = 'https://github.com/DanielPuentee/Outliersdetection',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/DanielPuentee/Outliersdetection/archive/refs/tags/v_1.0.tar.gz',    # I explain this later on
